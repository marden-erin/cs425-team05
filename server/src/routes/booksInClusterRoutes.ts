...
import { getBookFromCluster, addBookToCluster, updateBookInCluster, deleteBookFromCluster } from '../controllers/booksInClusterController'
...
booksInClusterRouter.put("/", addBookToCluster);

//updates book info in cluster
booksInClusterRouter.post("/", updateBookInCluster);
