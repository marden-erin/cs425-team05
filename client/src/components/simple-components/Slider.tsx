    ...
    return (
      <SliderWrapper>
        <div className='slider-div'>
            ...
            <Slider type="range" id={labelWithDashes + '-slider'} name={labelWithDashes + '-slider'} min={min} max={max} value={sliderValue} onChange={e => onInputChange(e.target.value)}/>
        </div>
        <div className='number-div'>
            <ThinInput className='number-input' id={labelWithDashes + '-input'} name={labelWithDashes + '-input'} value={inputValue} onChange={e => onInputChange(e.target.value)}/>
            <span> /{max}</span>
        </div>
      </SliderWrapper>
    );
